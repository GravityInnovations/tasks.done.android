...
public class TaskAdapter extends ArrayAdapter<TaskModel> {
	...
	public void setNewSelection(int position, boolean value) {
		/*
		 * for fixing gridView problems --position;
		 */
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (row == null) {
				...
				holder.update = (TextView) row.findViewById(R.id.updated1);
			...
			try {
				...
				Log.e("TaskAdapter", "doneToggleTC");
			}
			...
			try {
				...
				Log.e("TaskAdapter", "alarmToggleTC");
			}
			...
			Log.e("TaskAdapter", "onCreate Method");
		}
		/*
		 * this to show images at tasks Integer[] mThumbIds = {
		 * R.drawable.catag_home }; holder.gridView.setAdapter(new
		 * ImageGridAdapter(mThumbIds, mContext));
		 * holder.gridView.setOnItemClickListener(new OnItemClickListener() {
		 * public void onItemClick(AdapterView<?> parent, View v, int position,
		 * long id) { Toast.makeText(mContext, "" + position,
		 * Toast.LENGTH_SHORT) .show(); } }); this to show images at tasks
		 */
