...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_TASK_TITLE = "name";
    private static final String KEY_TASK_DETAILS = "phone_number";
    private static final String KEY_TASK_NOTES = "email";
